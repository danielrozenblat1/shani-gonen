...
import logo from "../../images/שני גונן לוגו.png"
...
const NavBarNew = () => {
  ...
  const handleWhatsAppClick = () => {
    ...
    const message = "היי שני הגעתי מהדף, אני רוצה לשמוע ממך עוד על..";
      ...
      <div className={styles.navbarInner}>
        ...
        <button className={styles.menuButton} onClick={handleWhatsAppClick}>
          <div className={styles.buttonContent}>
            <span className={styles.buttonText}>שני, בואי נדבר!</span>
        ...
        <div className={`${styles.mobileMenu} ${isClosing ? styles.closing : ''}`}>
          <div className={styles.mobileMenuHeader}>
            ...
            <div className={styles.mobileMenuLogo}>
              <img src={logo} alt="שני גונן לוגו"/>
            </div>
          </div>
