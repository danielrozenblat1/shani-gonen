    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.description}>
          ...
          אני מלווה נשים במסע שלהן. בלי שיפוט, בתהליך משותף ומעמיק, ובדרך שמחברת אותך פנימה –
        ...
        <p className={styles.description}>
          אני חלק ממסע הלהבות התאומות ואני חווה אותו בעצמי. 
          החיים שלי קיבלו נקודת מפנה משמעותית מאז שהכרתי את הלהבה שלי,
          וזה העמיק את ההבנה שלי בתחום ואת היכולת שלי להוביל נשים בדרכן לאיחוד אמיתי.
        </p>
      </div>
    </div>
