    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.description}>
          מגיל צעיר הרגשתי חיבור עמוק לעולם הטיפולי והרוחני, וידעתי שאהיה מטפלת זוגית.
        ...
        <p className={styles.description}>
          היום, אני כאן ממקום של תיקון. אחרי תהליך עמוק של ריפוי עצמי וחיבור לאנרגיה הנקבית שלי,
          אני מלווה נשים כמוך במסע דומה. בלי שיפוט, בלי הבטחות ריקות, ובדרך שמחברת אותך פנימה –
          כדי שתוכלי לרפא את הפצעים ולהפסיק לשחזר את הכאב. אני משלבת נומרולוגיה טיפולית, תקשור,
          תטא הילינג ואימון תודעתי, אני כאן להזכיר לך שהכל בסדר איתך –
          פשוט טרם קיבלת את הכלים הנכונים להביא את עצמך למימוש והגשמה בכל הרבדים.
        </p>
