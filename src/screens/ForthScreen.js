    ...
    <>
      ...
      <div className={styles.row}>
        ...
        <Box 
          ...
          description="תגלי את החיבור לחכמה הנשית שלך, תזכרי מי את באמת ותמצאי את הדרך למגנט אלייך שפע, מערכות יחסים בריאות וקבלת החלטות מתוך מקום מאוזן ושלם ולא ממקום של ריצוי האחר"
          icon={spiritualPath}
        />
      </div>
    </>
